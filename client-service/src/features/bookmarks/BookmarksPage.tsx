        ...
        <div className="sticky top-0 z-50 bg-black px-5 pt-4 pb-2">
          <div className="flex flex-col gap-6 p-6 rounded-[24px] bg-[#101828] border border-[#1e2939] shadow-xl relative overflow-hidden">
            ...
            <div className="flex items-center gap-4 relative z-10">
              ...
              <button
                type="button"
                className="w-10 h-10 rounded-[14px] bg-[#1e2939] border border-white/5 flex items-center justify-center text-slate-400 hover:text-white hover:bg-[#2a3649] transition-colors cursor-pointer"
              >
                <SettingsIcon />
              </button>
            </div>
